...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.initialiseRoutes = function () {
        this.router.post("/register", (0, validation_middleware_1.default)(user_validation_1.default.register), this.register);
        this.router.post("/login", (0, validation_middleware_1.default)(user_validation_1.default.login), this.login);
        this.router.get("/", authenticated_middleware_1.default, this.getUser);
    };
